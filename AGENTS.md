...
The agent layer is documented separately in [Email_agent/AGENTS.md](Email_agent/AGENTS.md). This file covers the whole-project picture and the web/backend services.
